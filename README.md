...
<p align="center">
  <a href="https://github.com/Heretek-AI/GrindrPlus/actions/workflows/build_apk.yml?query=branch%3Amaster+event%3Apush+is%3Acompleted"><img src="https://img.shields.io/github/actions/workflow/status/Heretek-AI/GrindrPlus/build_apk.yml?branch=master&logo=github&label=Build" alt="Build"></a>
  <img src="https://shields.io/github/downloads/Heretek-AI/GrindrPlus/total?logo=Bookmeter&label=Downloads&logoColor=Green&color=Green" alt="Total downloads">
...
## Introduction
This repository is maintained by [Heretek-AI](https://github.com/Heretek-AI) as a hard fork of [R0rt1z2's GrindrPlus](https://github.com/R0rt1z2/GrindrPlus) (which itself was a rewrite of [ElJaviLuki's original mod](https://github.com/ElJaviLuki/GrindrPlus)). It introduces new features, ensures compatibility with the latest Grindr versions, and offers improved performance and functionality.
...
Neither Heretek-AI nor any contributors listed here are affiliated with Grindr LLC.
...
## Downloads
* You can download the latest stable release by visiting the [releases page](https://github.com/Heretek-AI/GrindrPlus/releases).
* You can grab the most recent CI build from the [actions section](https://github.com/Heretek-AI/GrindrPlus/actions) or join our [Telegram CI channel](https://t.me/GrindrPlus).
...
**Process:**
1. Download & Install the GrindrPlus module APK (check the [downloads](https://github.com/Heretek-AI/GrindrPlus?tab=readme-ov-file#downloads) section of this `README`).
...
> **Make sure you're using [JingMatrix's fork of LSPosed](https://github.com/JingMatrix/LSPosed/releases)!**
...
**Process:**
1. Install the GrindrPlus module APK (check the [downloads](https://github.com/Heretek-AI/GrindrPlus?tab=readme-ov-file#downloads) section of this `README`)
...
- https://github.com/Heretek-AI/GrindrPlus/releases
</details>
<details>
...
## Acknowledgments
- [ElJaviLuki](https://github.com/ElJaviLuki/GrindrPlus) for the original mod and concept.
- [R0rt1z2](https://github.com/R0rt1z2/GrindrPlus) for the initial rewrite and earlier module updates.
- [@rhunk](https://github.com/rhunk) and the developers of [SnapEnhance](https://github.com/rhunk/SnapEnhance) for code techniques and ideas.
- [Vendetta's Manager](https://github.com/vendetta-mod/VendettaManager) for inspiration on the manager UI.
- Third-party library authors detailed in [build.gradle.kts](https://github.com/Heretek-AI/GrindrPlus/blob/master/app/build.gradle.kts).

## Contributing
This project is open to any kind of contribution. Feel free to [open a pull request](https://github.com/Heretek-AI/GrindrPlus/pulls) or [submit an issue](https://github.com/Heretek-AI/GrindrPlus/issues)! [Discussions](https://github.com/Heretek-AI/GrindrPlus/discussions) are also available!
...
## License
This project is distributed under the GPL-3.0 License. For more information, refer to the [LICENSE](https://github.com/Heretek-AI/GrindrPlus/blob/master/LICENSE) file. Please note that the [`old_base`](https://github.com/Heretek-AI/GrindrPlus/tree/old_base) branch is not subjected to any license, as the original author did not assign or attribute one.

As an open source project, you're free to learn from and build upon this code. Give proper credit and reference to the [Heretek-AI/GrindrPlus](https://github.com/Heretek-AI/GrindrPlus), upstream [R0rt1z2/GrindrPlus](https://github.com/R0rt1z2/GrindrPlus), and their [contributors](https://github.com/Heretek-AI/GrindrPlus/graphs/contributors).
