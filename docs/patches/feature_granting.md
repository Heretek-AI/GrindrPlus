...
<!-- Search markers used to locate this hook's symbols in newer Grindr APKs.
     Sourced from `FeatureGranting.kt`. When porting this hook to a new
...
val settingDistanceVisibilityViewModel = "sfa" // search for 'UiState(distanceVisibility='
val alertParams = "P" // search for 'AlertController.AlertParams'
