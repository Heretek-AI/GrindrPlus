...
<!-- Search markers used to locate this hook's symbols in newer Grindr APKs.
     Sourced from `NotificationAlerts.kt`. When porting this hook to a new
...
```kotlin
// NotificationAlerts.kt
val notificationManager = "cl5" // search for '0L, "notification_reminder_time"'
